...
const Home = () => {
  ...
  const PHONE = "(956) 643-5129";
  const EMAIL = "	longhorntruckingexpress@gmail.com";
  const MC_NUMBER = "1796804";
  const DOT_NUMBER = "4531341";
  ...
  const handleDownload = (docName) => {
    ...
    fetch(filePath)
      ...
      .then(blob => {
        ...
        link.href = url;
        link.setAttribute('download', `${docName.replace(/\s+/g, '_')}_LEO.jpg`);
  ...
  const handleUnlock = (e) => {
    e.preventDefault();
    if (accessCode.toUpperCase() === 'LEO2026') {
      setIsUnlocked(true); 
      setShowModal(false); 
      setError('');
    } else { 
      setError('Invalid Code. Try "LEO2026"'); 
    }
  };
  ...
  const handleQuoteRequest = (e) => {
    ...
    const subject = encodeURIComponent(`Quote Request: ${quoteOrigin} to ${quoteDest} - LONGHORN TRUCKING XPRESS LLC`);
    const body = encodeURIComponent(
      `Hi Andre,\n\nI am reaching out to request a quote for a load moving from ${quoteOrigin} to ${quoteDest}.\n\nEquipment Required: 26ft Box Truck\nCarrier: LONGHORN TRUCKING XPRESS LLC (MC# ${MC_NUMBER})\n\nPlease let me know your availability and rate for this lane.\n\nBest regards,`
    );
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up z-20">
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-none tracking-tight text-gray-900">
              <span className="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-red-400">LONGHORN TRUCKING</span><br /> XPRESS LLC
            </h1>
            
            <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
              <strong>US ↔ MEXICO BORDER / SOUTH TEXAS Specialist.</strong> <br/>
          ...
          <div className="relative w-full h-full animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            <div className="clip-trap relative z-10 bg-gray-800 aspect-[4/5] shadow-2xl group overflow-hidden">
              <img 
                src={heroTruck} 
                alt="LONGHORN TRUCKING XPRESS LLC 26ft International Box Truck" 
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
           {/* Image Side */}
            <div className="relative group hover-lift">
              ...
              <div className="absolute bottom-6 left-6 bg-black/80 backdrop-blur-md px-6 py-4 border-l-4 border-red-600 shadow-lg">
                <p className="font-black text-xl uppercase text-white">LEO DIAZ</p>
          ...
          <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed border-l-4 border-red-200 pl-4">
                "I operate under my own authority to kill the anxiety brokers feel when they hang up the phone. When you book LONGHORN TRUCKING XPRESS LLC, you aren't talking to a dispatcher—you're talking to the driver. 
                <br/><br/>
      ...
      <section id="lanes" className="py-20 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-gray-500 mb-12 max-w-2xl mx-auto">
                Specializing in US ↔ MEXICO BORDER / SOUTH TEXAS lanes. Open to structured backhauls or dedicated regional runs.
            </p>

            <div className="flex flex-wrap justify-center gap-4">
              {['TEXAS', 'MEXICO', 'CALIFORNIA', 'ARIZONA', 'NEW MEXICO', 'OKLAHOMA', 'LOUISIANA', 'FLORIDA'].map((state, index) => (
                <span 
                  key={state} 
          ...
          <div className="bg-[#111827] clip-trap p-8 md:p-12 relative overflow-hidden shadow-2xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
              <div className="text-left space-y-4 text-white">
                ...
                <p className="text-gray-400 text-lg leading-relaxed">Specializing in <strong>US ↔ MEXICO BORDER / SOUTH TEXAS</strong> lanes. Get a direct response from the owner-operator within minutes.</p>
              </div>
